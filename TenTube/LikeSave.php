...
$post_id = $_POST['id'];
$sql = mysqli_query($conn, "SELECT * FROM `likes` WHERE person = '{$person}' AND `post_id` = '{$post_id}' ") or die(mysqli_error());
if(mysqli_num_rows($sql) == 0){
 mysqli_query($conn, "INSERT INTO likes VALUES('', '$person', '$post_id')") or die(mysqli_error());
